...
from blink.biencoder.biencoder_ import load_biencoder
from blink.crossencoder.crossencoder import load_crossencoder
from blink.biencoder.data_process_ import (
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.path.join(os.path.dirname(__file__), 'models', 'biencoder_wiki_large.bin'),
        # default=os.path.join(os.path.dirname(__file__), 'models', 'pytorch_model.bin'),
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.path.join(os.path.dirname(__file__), 'models', 'biencoder_wiki_large.json'),
        # default=os.path.join(os.path.dirname(__file__), 'models', 'pytorch_model.json'),
    ...
    parser.add_argument(
        ...
        default=os.path.join(os.path.dirname(__file__), 'models', 'entity.jsonl'),  # ALL WIKIPEDIA!
        # default="/home/ubuntu/Desktop/BLINK-main/blink/biencoder/data/ccks2019/kb_data"
    ...
    parser.add_argument(
        ...
        default=os.path.join(os.path.dirname(__file__), 'models', 'all_entities_large.t7'),  # ALL WIKIPEDIA!
        # default="/home/ubuntu/Desktop/BLINK-main/blink/biencoder/data/ccks2019/can_encode"
        help="Path to the entity catalogue.",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.path.join(os.path.dirname(__file__), 'models', 'crossencoder_wiki_large.bin'),
    ...
    parser.add_argument(
        ...
        type=str,
        default=os.path.join(os.path.dirname(__file__), 'models', 'crossencoder_wiki_large.json'),
    ...
    parser.add_argument(
        ...
        type=str,
        default="output",
        # default="/home/ubuntu/Desktop/BLINK-main/blink/biencoder/models",
    ...
    parser.add_argument(
        ...
        # default="/home/ubuntu/Desktop/BLINK-main/blink/biencoder/data/ccks2019/index"
    )
