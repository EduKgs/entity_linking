...
class CrossEncoderModule(torch.nn.Module):
    def __init__(self, params, tokenizer):
        ...
        model_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), params["bert_model"])
...
class CrossEncoderRanker(torch.nn.Module):
    def __init__(self, params, shared=None):
        ...
        if params.get("roberta"):
            self.tokenizer = RobertaTokenizer.from_pretrained(os.path.join(os.path.dirname(os.path.dirname(__file__)), params["bert_model"]))
        else:
